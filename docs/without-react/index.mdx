...
> [!NOTE]
> The following assumes your are building your app with vite. If you are using a different built tool, you need manually assure that the viverse app id is provided only during the production built.
